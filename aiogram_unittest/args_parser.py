...
class ArgumentsParser:
    ...
    def get_copy_message_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('chat_id', 'from_chat_id', 'message_id', 'caption', 'parse_mode', 'caption_entities',
                'disable_notification', 'protect_content', 'reply_to_message_id', 'allow_sending_without_reply',
                'reply_markup', 'payload', 'result')
        return cls._get_async_mock_args(keys, async_mock_args)
    ...
    def get_create_invoice_link_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('title', 'description', 'payload', 'provider_token', 'currency', 'prices', 'max_tip_amount',
                'suggested_tip_amounts', 'provider_data', 'photo_url', 'photo_size', 'photo_width', 'photo_height',
    ...
    def get_create_new_sticker_set_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('user_id', 'name', 'title', 'emojis', 'png_sticker', 'tgs_sticker', 'webm_sticker', 'contains_masks',
                'sticker_type', 'mask_position', 'payload', 'files')
        return cls._get_async_mock_args(keys, async_mock_args)
    ...
    def get_download_file_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('file_path', 'destination', 'timeout', 'chunk_size', 'seek', 'destination_dir', 'make_dirs', 'url',
                'dest', 'session', 'response', 'chunk')
        return cls._get_async_mock_args(keys, async_mock_args)
    ...
    def get_edit_chat_invite_link_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('chat_id', 'invite_link', 'expire_date', 'member_limit', 'name', 'creates_join_request', 'payload',
                'result')
        return cls._get_async_mock_args(keys, async_mock_args)

    @classmethod
    def get_edit_message_caption_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('chat_id', 'message_id', 'inline_message_id', 'caption', 'parse_mode', 'caption_entities',
                'reply_markup', 'payload', 'result')
        return cls._get_async_mock_args(keys, async_mock_args)

    @classmethod
    def get_edit_message_live_location_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('latitude', 'longitude', 'chat_id', 'message_id', 'inline_message_id', 'horizontal_accuracy', 'heading',
                'proximity_alert_radius', 'reply_markup', 'payload', 'result')
        return cls._get_async_mock_args(keys, async_mock_args)
    ...
    def get_edit_message_text_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('text', 'chat_id', 'message_id', 'inline_message_id', 'parse_mode', 'entities',
                'disable_web_page_preview', 'reply_markup', 'payload', 'result')
        return cls._get_async_mock_args(keys, async_mock_args)
    ...
    def get_promote_chat_member_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('chat_id', 'user_id', 'is_anonymous', 'can_manage_chat', 'can_change_info', 'can_post_messages',
                'can_edit_messages', 'can_delete_messages', 'can_manage_voice_chats', 'can_invite_users',
                'can_restrict_members', 'can_pin_messages', 'can_promote_members', 'can_manage_video_chats', 'payload')
        return cls._get_async_mock_args(keys, async_mock_args)
    ...
    def get_restrict_chat_member_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('chat_id', 'user_id', 'permissions', 'until_date', 'can_send_messages', 'can_send_media_messages',
                'can_send_other_messages', 'can_add_web_page_previews', 'payload', 'permission')
        return cls._get_async_mock_args(keys, async_mock_args)
    ...
    def get_send_animation_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('chat_id', 'animation', 'duration', 'width', 'height', 'thumb', 'caption', 'parse_mode',
                'caption_entities', 'disable_notification', 'protect_content', 'reply_to_message_id',
                'allow_sending_without_reply', 'reply_markup', 'payload', 'files', 'result')
        return cls._get_async_mock_args(keys, async_mock_args)

    @classmethod
    def get_send_audio_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('chat_id', 'audio', 'caption', 'parse_mode', 'caption_entities', 'duration', 'performer', 'title',
    ...
    def get_send_contact_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('chat_id', 'phone_number', 'first_name', 'last_name', 'vcard', 'disable_notification',
                'protect_content', 'reply_to_message_id', 'allow_sending_without_reply', 'reply_markup', 'payload',
                'result')
        return cls._get_async_mock_args(keys, async_mock_args)

    @classmethod
    def get_send_dice_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('chat_id', 'disable_notification', 'protect_content', 'emoji', 'reply_to_message_id',
                'allow_sending_without_reply', 'reply_markup', 'payload', 'result')
        return cls._get_async_mock_args(keys, async_mock_args)

    @classmethod
    def get_send_document_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('chat_id', 'document', 'thumb', 'caption', 'parse_mode', 'caption_entities',
    ...
    def get_send_game_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('chat_id', 'game_short_name', 'disable_notification', 'protect_content', 'reply_to_message_id',
                'allow_sending_without_reply', 'reply_markup', 'payload', 'result')
        return cls._get_async_mock_args(keys, async_mock_args)

    @classmethod
    def get_send_invoice_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('chat_id', 'title', 'description', 'payload', 'provider_token', 'currency', 'prices', 'max_tip_amount',
                'suggested_tip_amounts', 'start_parameter', 'provider_data', 'photo_url', 'photo_size', 'photo_width',
                ...
                'protect_content', 'reply_to_message_id', 'allow_sending_without_reply', 'reply_markup', 'payload_',
                'result')
        return cls._get_async_mock_args(keys, async_mock_args)

    @classmethod
    def get_send_location_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('chat_id', 'latitude', 'longitude', 'horizontal_accuracy', 'live_period', 'heading',
    ...
    def get_send_media_group_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('chat_id', 'media', 'disable_notification', 'protect_content', 'reply_to_message_id',
                'allow_sending_without_reply', 'files', 'payload', 'result')
        return cls._get_async_mock_args(keys, async_mock_args)

    @classmethod
    def get_send_message_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('chat_id', 'text', 'parse_mode', 'entities', 'disable_web_page_preview', 'disable_notification',
                'protect_content', 'reply_to_message_id', 'allow_sending_without_reply', 'reply_markup', 'payload',
                'result')
        return cls._get_async_mock_args(keys, async_mock_args)
    ...
    def get_send_photo_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('chat_id', 'photo', 'caption', 'parse_mode', 'caption_entities', 'disable_notification',
                'protect_content', 'reply_to_message_id', 'allow_sending_without_reply', 'reply_markup', 'payload',
                'files', 'result')
        return cls._get_async_mock_args(keys, async_mock_args)
    ...
    def get_send_poll_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('chat_id', 'question', 'options', 'is_anonymous', 'type', 'allows_multiple_answers',
    ...
    def get_send_sticker_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('chat_id', 'sticker', 'disable_notification', 'protect_content', 'reply_to_message_id',
                'allow_sending_without_reply', 'reply_markup', 'payload', 'files', 'result')
        return cls._get_async_mock_args(keys, async_mock_args)

    @classmethod
    def get_send_venue_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('chat_id', 'latitude', 'longitude', 'title', 'address', 'foursquare_id', 'foursquare_type',
                'google_place_id', 'google_place_type', 'disable_notification', 'protect_content',
                'reply_to_message_id', 'allow_sending_without_reply', 'reply_markup', 'payload', 'result')
        return cls._get_async_mock_args(keys, async_mock_args)

    @classmethod
    def get_send_video_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('chat_id', 'video', 'duration', 'width', 'height', 'thumb', 'caption', 'parse_mode', 'caption_entities',
                'supports_streaming', 'disable_notification', 'protect_content', 'reply_to_message_id',
                'allow_sending_without_reply', 'reply_markup', 'payload', 'files', 'result')
        return cls._get_async_mock_args(keys, async_mock_args)

    @classmethod
    def get_send_video_note_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('chat_id', 'video_note', 'duration', 'length', 'thumb', 'disable_notification', 'protect_content',
                'reply_to_message_id', 'allow_sending_without_reply', 'reply_markup', 'payload', 'files', 'result')
        return cls._get_async_mock_args(keys, async_mock_args)

    @classmethod
    def get_send_voice_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('chat_id', 'voice', 'caption', 'parse_mode', 'caption_entities', 'duration', 'disable_notification',
                'protect_content', 'reply_to_message_id', 'allow_sending_without_reply', 'reply_markup', 'payload',
                'files', 'result')
        return cls._get_async_mock_args(keys, async_mock_args)
    ...
    def get_set_game_score_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('user_id', 'score', 'force', 'disable_edit_message', 'chat_id', 'message_id', 'inline_message_id',
                'payload', 'result')
        return cls._get_async_mock_args(keys, async_mock_args)
    ...
    def get_set_webhook_args(cls, async_mock_args) -> Dict[str, Any]:
        keys = ('url', 'certificate', 'ip_address', 'max_connections', 'allowed_updates', 'drop_pending_updates',
                'secret_token', 'payload', 'files')
        return cls._get_async_mock_args(keys, async_mock_args)
